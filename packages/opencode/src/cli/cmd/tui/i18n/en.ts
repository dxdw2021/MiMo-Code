export const dict: Record<string, string> = {
  ...
  "tui.never_ask.badge": "Never-ask: ON",
  ...
  "tui.dialog.image.starry": "Starry night",
  "tui.dialog.image.matrix": "Matrix rain",
  "tui.dialog.image.waves": "Color waves",
  "tui.dialog.image.fire": "Fire embers",
  "tui.dialog.image.snow": "Snowfall",
  "tui.dialog.image.rain": "Rain",
  "tui.dialog.image.aurora": "Aurora",
  "tui.dialog.image.plasma": "Plasma",
  "tui.dialog.image.bubbles": "Bubbles",
  "tui.dialog.image.confetti": "Confetti",
  "tui.dialog.image.ripple": "Ripples",
  "tui.dialog.image.pulse": "Pulse",
  "tui.dialog.image.drift": "Drift",
  "tui.dialog.image.twinkle": "Twinkle stars",
  ...
  "tui.permission.edit_title": "Edit {{path}}",
  "tui.permission.read_title": "Read {{path}}",
  "tui.permission.path_label": "Path: {{path}}",
  "tui.permission.glob_title": "Glob \"{{pattern}}\"",
  "tui.permission.grep_title": "Grep \"{{pattern}}\"",
  "tui.permission.pattern_label": "Pattern: {{pattern}}",
  "tui.permission.list_title": "List {{path}}",
  "tui.permission.shell_command": "Shell command",
  "tui.permission.unknown": "Unknown",
  "tui.permission.task_title": "{{type}} Task",
  "tui.permission.webfetch_title": "WebFetch {{url}}",
  "tui.permission.url_label": "URL: {{url}}",
  "tui.permission.websearch_title": "Web Search \"{{query}}\"",
  "tui.permission.codesearch_title": "Exa Code Search \"{{query}}\"",
  "tui.permission.query_label": "Query: {{query}}",
  "tui.permission.ext_dir_title": "Access external directory {{dir}}",
  "tui.permission.patterns_label": "Patterns",
  ...
  "tui.permission.call_tool_title": "Call tool {{tool}}",
  "tui.permission.tool_label": "Tool: {{tool}}",

  // Question dialog
  "tui.question.confirm_tab": "Confirm",
  "tui.question.select_all": " (select all that apply)",
  "tui.question.custom_answer": "Type your own answer",
  "tui.question.review_title": "Review",
  "tui.question.not_answered": "(not answered)",

  // Prompt hint
  "tui.prompt.hint.minimize": "minimize",
  "tui.prompt.hint.fullscreen": "fullscreen",
  "tui.prompt.hint.select": "select",
  "tui.prompt.hint.confirm": "confirm",
  "tui.prompt.hint.tab": "tab",
  "tui.prompt.hint.submit": "submit",
  "tui.prompt.hint.toggle": "toggle",
  "tui.prompt.hint.dismiss": "dismiss",
  ...
  "tui.dialog.skill.loading": "Loading skill...",
  ...
  "tui.dialog.provider.wizard.provider_id": "Provider id",
  "tui.dialog.provider.wizard.provider_id_placeholder": "e.g. mimorouter",
  "tui.dialog.provider.wizard.display_name": "Display name",
  "tui.dialog.provider.wizard.display_name_placeholder": "e.g. MiMo Router",
  "tui.dialog.provider.wizard.base_url": "Base URL",
  "tui.dialog.provider.wizard.base_url_placeholder": "https://.../v1",
  "tui.dialog.provider.wizard.api_key": "API key",
  "tui.dialog.provider.wizard.api_key_placeholder": "sk-...",
  "tui.dialog.provider.wizard.first_model_id": "First model id",
  "tui.dialog.provider.wizard.first_model_id_placeholder": "e.g. claude-sonnet-4-6",
  "tui.dialog.provider.wizard.first_model_name": "First model name",
  "tui.dialog.provider.wizard.first_model_name_placeholder": "e.g. Claude Sonnet 4.6",

  // Model dialog
  "tui.dialog.model.add_model": "+ Add model",
  ...
  "tui.dialog.model.add_wizard.model_id": "Model id",
  "tui.dialog.model.add_wizard.model_id_placeholder": "gateway model id",
  "tui.dialog.model.add_wizard.display_name": "Display name",
  "tui.dialog.model.add_wizard.display_name_placeholder": "shown in model picker",
  ...
  "tui.command.desc.dream": "manually consolidate project memory from memory files and raw trajectory",
  "tui.command.desc.distill": "find repeated workflows in recent work and package them into skills, subagents, or commands",
  "tui.command.desc.goal": "set a stop-condition goal; runs until a judge says it's met. /goal clear to abort",
  "tui.command.desc.deep-research": "deep multi-source, fact-checked research report (runs the deep-research workflow)",
  ...
  "tui.command.config.reload.title": "Reload config",
  "tui.command.config.reload.description": "Reload project configuration, providers, and plugins",
  "tui.command.config.reload.toast": "Config reloaded",
  ...
  "tui.toast.exported": "Session exported to {{filename}}",
  "tui.toast.worktree_switched": "Switched to {{dir}}",
  "tui.toast.workspace_restored": "Session restored into the new workspace",
  "tui.toast.workspace_create_failed": "Creating workspace failed",
  "tui.toast.workspace_created_failed": "Failed to create workspace: {{msg}}",
  "tui.toast.restore_failed": "Failed to restore session: {{msg}}",
  "tui.toast.org_switched": "Switched to {{org}}",
  "tui.toast.connect_provider_summarize": "Connect a provider to summarize this session",
  "tui.toast.session_create_failed": "Creating a session failed. Open console for more details.",
  "tui.toast.provider_prompt": "Connect a provider to send prompts",

  // Error messages
  "tui.error.copy_url_failed": "Failed to copy URL to clipboard",
  "tui.error.share_failed": "Failed to share session",
  "tui.error.unshare_failed": "Failed to unshare session",
  "tui.error.copy_clipboard_failed": "Failed to copy to clipboard",
  "tui.error.copy_transcript_failed": "Failed to copy session transcript",
  "tui.error.export_failed": "Failed to export session",
  "tui.error.workspace_adaptor_failed": "Failed to load workspace adaptors",
  "tui.error.workspace_create_failed": "Failed to create workspace session",
  "tui.error.worktree_create_failed": "Failed to create worktree",
  "tui.error.send_message_failed": "Failed to send message",
  "tui.error.delete_workspace_failed": "Failed to delete workspace",
  "tui.error.delete_session_failed": "Failed to delete session",

  "tui.dialog.session_list.title": "Sessions",
  "tui.dialog.session_list.today": "Today",
  "tui.dialog.session_list.delete": "delete",
  "tui.dialog.session_list.rename": "rename",
  "tui.dialog.session_list.new_workspace": "new workspace",
  ...
  "tui.dialog.workflows.resume_title": "Resume workflow",
  "tui.dialog.workflows.resume_body": "Re-run \"{{name}}\"? This re-executes the workflow and may incur cost.",
  "tui.dialog.org.title": "Switch org",
  "tui.dialog.org.loading": "Loading orgs...",
  "tui.dialog.org.no_orgs": "No orgs found",
  "tui.dialog.model.popular_providers": "Popular providers",
  "tui.dialog.model.favorites": "Favorites",
  "tui.dialog.model.recent": "Recent",
  "tui.dialog.model.free_label": "Free",
  "tui.dialog.provider.category_popular": "Popular",
  "tui.dialog.provider.category_other": "Other",
  "tui.dialog.provider.auth_api_key": "API key",
  "tui.dialog.provider.opencode_desc": "(Recommended)",
  "tui.dialog.provider.anthropic_desc": "(API key)",
  "tui.dialog.provider.openai_desc": "(ChatGPT Plus/Pro or API key)",
  "tui.dialog.provider.opencode_go_desc": "Low cost subscription for everyone",
  ...
  "tui.dialog.status.no_formatters": "No Formatters",
  "tui.dialog.status.no_plugins": "No Plugins",
  ...
  "tui.dialog.stash.lines": "~{{n}} lines",
  "tui.dialog.stash.delete": "delete",
  "tui.dialog.stash.confirm_delete_prefix": "Press",
  "tui.dialog.stash.confirm_delete_suffix": "again to confirm",
  "tui.dialog.timeline.title": "Timeline",
  "tui.dialog.subagent.title": "Subagents",
  "tui.dialog.subagent.empty": "(no subagents in this session)",
  "tui.dialog.subagent.empty_desc": "spawn one via the actor tool",
  "tui.dialog.fork.title": "Fork session",
  "tui.dialog.fork.full_session": "Full session",
  "tui.dialog.delete_failed.title": "Failed to Delete Session",
  "tui.dialog.delete_failed.desc": "The session \"{{session}}\" could not be deleted because the workspace \"{{workspace}}\" is not available.",
  "tui.dialog.delete_failed.hint": "Choose how you want to recover this broken workspace session.",
  "tui.dialog.delete_failed.delete_workspace": "Delete workspace",
  "tui.dialog.delete_failed.delete_workspace_desc": "Delete the workspace and all sessions attached to it.",
  "tui.dialog.delete_failed.restore": "Restore to new workspace",
  "tui.dialog.delete_failed.restore_desc": "Try to restore this session into a new workspace.",
  "tui.dialog.unavailable.title": "Workspace Unavailable",
  "tui.dialog.unavailable.desc": "This session is attached to a workspace that is no longer available.",
  "tui.dialog.unavailable.restore_prompt": "Would you like to restore this session into a new workspace?",
  "tui.dialog.unavailable.restore": "restore",
  "tui.dialog.unavailable.cancel": "cancel",
  "tui.dialog.workspace_create.title_new": "New Workspace",
  "tui.dialog.workspace_create.title_creating": "Creating Workspace",
  "tui.dialog.workspace_create.creating": "Creating {{type}} workspace...",
  "tui.dialog.workspace_create.creating_desc": "This can take a while for remote environments",
  "tui.dialog.workspace_create.loading": "Loading workspaces...",
  "tui.dialog.workspace_create.loading_desc": "Fetching available workspace adaptors",
  "tui.dialog.go_upsell.title": "Free limit reached",
  "tui.dialog.go_upsell.subscribe": "Subscribe to ",
  "tui.dialog.go_upsell.product": "OpenCode Go",
  "tui.dialog.go_upsell.description": " for reliable access to the",
  "tui.dialog.go_upsell.price": "best open-source models, starting at $5/month.",
  "tui.dialog.go_upsell.dont_show": "don't show again",
  "tui.dialog.go_upsell.subscribe_btn": "subscribe",
  "tui.session.exit_confirm": "Session",
  "tui.session.exit_continue": "Continue",
  "tui.session.revert_hint": " or /redo to restore",
  "tui.session.reverted": "{{count}} message reverted",
  "tui.session.queue": "QUEUED",
  "tui.session.judge_error": "Judge: error (stopped)",
  "tui.session.judge_met": "Judge: met",
  "tui.session.judge_impossible": "Judge: impossible",
  "tui.session.judge_not_met": "Judge [round {{n}}]: not met",
  "tui.session.view_subagents": " view subagents",
  "tui.tool.questions_title": "# Questions",
  "tui.footer.connect": "Get started ",
  "tui.footer.slash_connect": "/connect",
  "tui.footer.permission_singular": " {{n}} Permission",
  "tui.footer.permission_plural_suffix": "s",
  "tui.footer.lsp": " LSP",
  "tui.footer.mcp": " MCP",
  "tui.footer.status": "/status",
  "tui.subagent.label": "Subagent",
  "tui.subagent.of": " of ",
  "tui.subagent.main": "Main ",
  "tui.subagent.prev": "Prev ",
  "tui.subagent.next": "Next ",
  "tui.plugin.unknown_route": "Unknown plugin route: ",
  "tui.plugin.go_home": "go home",
  "tui.startup.finishing": "Finishing startup...",
  "tui.startup.loading_plugins": "Loading plugins...",
  "tui.prompt.shell_label": "SHELL",
  "tui.dialog.share.title": "Share Session",
  "tui.dialog.share.body": "Are you sure you want to share it?",
  "tui.dialog.redo.title": "Confirm Redo",
  "tui.dialog.redo.body": "Are you sure you want to restore the reverted messages?",

  // Agent names
  "tui.agent.name.build": "Build",
  "tui.agent.name.plan": "Plan",
  "tui.agent.name.compose": "Compose",

  // Variant names
  "tui.variant.name.high": "High",
  "tui.variant.name.medium": "Medium",
  "tui.variant.name.low": "Low",
  "tui.variant.name.xhigh": "XHigh",
  "tui.variant.name.max": "Max",

  // Variant dialog
  "tui.dialog.variant.title": "Variant",
  "tui.dialog.variant.default": "Default",
  "tui.dialog.variant.high": "High",
  "tui.dialog.variant.medium": "Medium",
  "tui.dialog.variant.low": "Low",
