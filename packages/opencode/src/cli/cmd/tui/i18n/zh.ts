...
export const dict = {
  ...
  "tui.tips.tab_agent":
    "按 {highlight}Tab{/highlight} 或 {highlight}Shift+Tab{/highlight} 在 构建 / 规划 / 编排 智能体之间切换",
  "tui.tips.theme_mode":
  ...
  "tui.tips.plan_agent": "切换到 {highlight}规划{/highlight} 智能体以获取建议而不实际改动",
  ...
  "tui.dialog.image.matrix": "矩阵雨",
  "tui.dialog.image.waves": "彩色波浪",
  "tui.dialog.image.solid": "纯色背景",
  ...
  "tui.dialog.image.aurora": "极光",
  "tui.dialog.image.plasma": "等离子",
  "tui.dialog.image.bubbles": "气泡",
  "tui.dialog.image.confetti": "五彩纸屑",
  "tui.dialog.image.ripple": "涟漪",
  "tui.dialog.image.pulse": "脉冲",
  "tui.dialog.image.drift": "漂流",
  "tui.dialog.image.twinkle": "闪烁星星",
  ...
  "tui.permission.no_diff": "无差异内容",
  "tui.permission.edit_title": "编辑 {{path}}",
  "tui.permission.read_title": "读取 {{path}}",
  "tui.permission.path_label": "路径：{{path}}",
  "tui.permission.glob_title": "Glob \"{{pattern}}\"",
  "tui.permission.grep_title": "Grep \"{{pattern}}\"",
  "tui.permission.pattern_label": "模式：{{pattern}}",
  "tui.permission.list_title": "列出 {{path}}",
  "tui.permission.shell_command": "Shell 命令",
  "tui.permission.unknown": "未知",
  "tui.permission.task_title": "{{type}} 任务",
  "tui.permission.webfetch_title": "WebFetch {{url}}",
  "tui.permission.url_label": "URL：{{url}}",
  "tui.permission.websearch_title": "Web 搜索 \"{{query}}\"",
  "tui.permission.codesearch_title": "Exa 代码搜索 \"{{query}}\"",
  "tui.permission.query_label": "查询：{{query}}",
  "tui.permission.ext_dir_title": "访问外部目录 {{dir}}",
  "tui.permission.patterns_label": "模式",
  "tui.permission.doom_loop_title": "在反复失败后继续",
  "tui.permission.doom_loop_desc": "让会话在反复失败的情况下继续运行。",
  "tui.permission.call_tool_title": "调用工具 {{tool}}",
  "tui.permission.tool_label": "工具：{{tool}}",

  // Question dialog
  "tui.question.confirm_tab": "确认",
  "tui.question.select_all": "（可多选）",
  "tui.question.custom_answer": "输入自定义答案",
  "tui.question.review_title": "回顾",
  "tui.question.not_answered": "（未回答）",

  // Prompt hint
  "tui.prompt.hint.minimize": "最小化",
  "tui.prompt.hint.fullscreen": "全屏",
  "tui.prompt.hint.select": "选择",
  "tui.prompt.hint.confirm": "确认",
  "tui.prompt.hint.tab": "切换",
  "tui.prompt.hint.submit": "提交",
  "tui.prompt.hint.toggle": "切换",
  ...
  "tui.dialog.skill.loading": "加载技能中...",
  ...
  "tui.dialog.provider.custom_provider": "+ 自定义服务商",
  "tui.dialog.provider.wizard.provider_id": "服务商标识",
  "tui.dialog.provider.wizard.provider_id_placeholder": "例如：mimorouter",
  "tui.dialog.provider.wizard.display_name": "显示名称",
  "tui.dialog.provider.wizard.display_name_placeholder": "例如：MiMo Router",
  "tui.dialog.provider.wizard.base_url": "基础地址",
  "tui.dialog.provider.wizard.base_url_placeholder": "https://.../v1",
  "tui.dialog.provider.wizard.api_key": "API 密钥",
  "tui.dialog.provider.wizard.api_key_placeholder": "sk-...",
  "tui.dialog.provider.wizard.first_model_id": "首个模型标识",
  "tui.dialog.provider.wizard.first_model_id_placeholder": "例如：claude-sonnet-4-6",
  "tui.dialog.provider.wizard.first_model_name": "首个模型名称",
  "tui.dialog.provider.wizard.first_model_name_placeholder": "例如：Claude Sonnet 4.6",

  // Model dialog
  "tui.dialog.model.add_model": "+ 添加模型",
  "tui.dialog.model.select_model": "选择模型",
  "tui.dialog.model.connect_provider": "连接服务商",
  "tui.dialog.model.view_all_providers": "查看所有服务商",
  "tui.dialog.model.favorite": "收藏",
  "tui.dialog.model.add_wizard.model_id": "模型标识",
  "tui.dialog.model.add_wizard.model_id_placeholder": "网关模型标识",
  "tui.dialog.model.add_wizard.display_name": "显示名称",
  "tui.dialog.model.add_wizard.display_name_placeholder": "模型选择器中显示的名称",
  ...
  "tui.command.desc.dream": "从记忆文件和原始轨迹中手动整合项目记忆",
  "tui.command.desc.distill": "在近期工作中发现重复工作流，封装为 skills、subagents 或 commands",
  "tui.command.desc.goal": "设置停止条件目标；持续运行直到评估机制判定目标达成，使用 /goal clear 中止",
  "tui.command.desc.deep-research": "深度多源、事实核查的研究报告（运行 deep-research 工作流）",
  ...
  "tui.command.config.reload.title": "重新加载配置",
  "tui.command.config.reload.description": "重新加载项目配置、服务商和插件",
  "tui.command.config.reload.toast": "配置已重新加载",
  ...
  // Retry display
  "tui.prompt.retry.retrying": "正在重试",
  "tui.prompt.retry.inDuration": "{{duration}}后",
  ...
  "tui.update.complete.message": "已成功更新到 MiMoCode v{{version}}，请重新启动应用。",
  "tui.error.invalid_model": "模型格式无效：{{model}}",
  "tui.error.interactive_reply_failed": "交互命令回复失败：{{error}}",
  "tui.bash.interactive": "（交互式）",
  "tui.toast.exported": "会话已导出至 {{filename}}",
  "tui.toast.worktree_switched": "已切换至 {{dir}}",
  "tui.toast.workspace_restored": "会话已恢复到新工作区",
  "tui.toast.workspace_create_failed": "创建工作区失败",
  "tui.toast.workspace_created_failed": "创建工作区失败：{{msg}}",
  "tui.toast.restore_failed": "恢复会话失败：{{msg}}",
  "tui.toast.org_switched": "已切换至 {{org}}",
  "tui.toast.connect_provider_summarize": "请连接服务商来汇总此会话",
  "tui.toast.session_create_failed": "创建会话失败。打开控制台查看详细信息。",
  "tui.toast.provider_prompt": "请连接服务商后再发送消息",

  // Error messages
  "tui.error.copy_url_failed": "复制链接到剪贴板失败",
  "tui.error.share_failed": "分享会话失败",
  "tui.error.unshare_failed": "取消分享失败",
  "tui.error.copy_clipboard_failed": "复制到剪贴板失败",
  "tui.error.copy_transcript_failed": "复制会话记录失败",
  "tui.error.export_failed": "导出会话失败",
  "tui.error.workspace_adaptor_failed": "加载工作区适配器失败",
  "tui.error.workspace_create_failed": "创建工作区会话失败",
  "tui.error.worktree_create_failed": "创建工作树失败",
  "tui.error.send_message_failed": "发送消息失败",
  "tui.error.delete_workspace_failed": "删除工作区失败",
  "tui.error.delete_session_failed": "删除会话失败",

  "tui.dialog.session_list.title": "会话",
  "tui.dialog.session_list.today": "今天",
  "tui.dialog.session_list.delete": "删除",
  "tui.dialog.session_list.rename": "重命名",
  "tui.dialog.session_list.new_workspace": "新建工作区",
  "tui.dialog.session_rename.title": "重命名会话",
  "tui.dialog.worktree.title": "工作树",
  "tui.dialog.worktree.loading": "加载工作树中...",
  "tui.dialog.worktree.create": "+ 新建工作树",
  "tui.dialog.worktree.switching": "切换工作树中...",
  "tui.dialog.workflows.title": "工作流",
  "tui.dialog.workflows.no_runs": "（暂无工作流运行）",
  "tui.dialog.workflows.resume_title": "恢复工作流",
  "tui.dialog.workflows.resume_body": "重新运行「{{name}}」？这会重新执行工作流并可能产生费用。",
  "tui.dialog.org.title": "切换组织",
  "tui.dialog.org.loading": "加载组织中...",
  "tui.dialog.org.no_orgs": "未找到组织",
  "tui.dialog.model.popular_providers": "热门服务商",
  "tui.dialog.model.favorites": "收藏",
  "tui.dialog.model.recent": "最近使用",
  "tui.dialog.model.free_label": "免费",
  "tui.dialog.provider.category_popular": "热门",
  "tui.dialog.provider.category_other": "其他",
  "tui.dialog.provider.auth_api_key": "API 密钥",
  "tui.dialog.provider.opencode_desc": "（推荐）",
  "tui.dialog.provider.anthropic_desc": "（API 密钥）",
  "tui.dialog.provider.openai_desc": "（ChatGPT Plus/Pro 或 API 密钥）",
  "tui.dialog.provider.opencode_go_desc": "面向所有人的低价订阅",
  ...
  "tui.dialog.status.no_formatters": "无格式化器",
  "tui.dialog.status.no_plugins": "无插件",
  ...
  "tui.dialog.stash.lines": "~{{n}} 行",
  "tui.dialog.stash.delete": "删除",
  "tui.dialog.stash.confirm_delete_prefix": "按",
  "tui.dialog.stash.confirm_delete_suffix": "再次确认删除",
  "tui.dialog.timeline.title": "时间线",
  "tui.dialog.subagent.title": "子智能体",
  "tui.dialog.subagent.empty": "（此会话中无子智能体）",
  "tui.dialog.subagent.empty_desc": "通过 actor 工具创建",
  "tui.dialog.fork.title": "派生会话",
  "tui.dialog.fork.full_session": "完整会话",
  "tui.dialog.delete_failed.title": "删除会话失败",
  "tui.dialog.delete_failed.desc": "会话「{{session}}」无法删除，因为工作区「{{workspace}}」不可用。",
  "tui.dialog.delete_failed.hint": "选择如何恢复此损坏的工作区会话。",
  "tui.dialog.delete_failed.delete_workspace": "删除工作区",
  "tui.dialog.delete_failed.delete_workspace_desc": "删除工作区及其所有会话",
  "tui.dialog.delete_failed.restore": "恢复到新工作区",
  "tui.dialog.delete_failed.restore_desc": "尝试将此会话恢复到新工作区",
  "tui.dialog.unavailable.title": "工作区不可用",
  "tui.dialog.unavailable.desc": "此会话关联的工作区已不可用。",
  "tui.dialog.unavailable.restore_prompt": "是否将此会话恢复到新工作区？",
  "tui.dialog.unavailable.restore": "恢复",
  "tui.dialog.unavailable.cancel": "取消",
  "tui.dialog.workspace_create.title_new": "新建工作区",
  "tui.dialog.workspace_create.title_creating": "创建中",
  "tui.dialog.workspace_create.creating": "正在创建 {{type}} 工作区...",
  "tui.dialog.workspace_create.creating_desc": "远程环境可能需要较长时间",
  "tui.dialog.workspace_create.loading": "加载工作区中...",
  "tui.dialog.workspace_create.loading_desc": "正在获取可用工作区适配器",
  "tui.dialog.go_upsell.title": "免费额度已达上限",
  "tui.dialog.go_upsell.subscribe": "订阅 ",
  "tui.dialog.go_upsell.product": "OpenCode Go",
  "tui.dialog.go_upsell.description": "，获得对",
  "tui.dialog.go_upsell.price": "最佳开源模型的稳定访问，起价 $5/月。",
  "tui.dialog.go_upsell.dont_show": "不再显示",
  "tui.dialog.go_upsell.subscribe_btn": "订阅",
  "tui.session.exit_confirm": "会话",
  "tui.session.exit_continue": "继续",
  "tui.session.revert_hint": "或 /redo 来恢复",
  "tui.session.reverted": "已撤回 {{count}} 条消息",
  "tui.session.queue": "排队中",
  "tui.session.judge_error": "判定：错误（已停止）",
  "tui.session.judge_met": "判定：已达标",
  "tui.session.judge_impossible": "判定：无法实现",
  "tui.session.judge_not_met": "判定 [第{{n}}轮]：未达标",
  "tui.session.view_subagents": "查看子智能体",
  "tui.tool.questions_title": "# 问题",
  "tui.footer.connect": "开始使用 ",
  "tui.footer.slash_connect": "/connect",
  "tui.footer.permission_singular": " {{n}} 个权限",
  "tui.footer.permission_plural_suffix": "",
  "tui.footer.lsp": " 个 LSP",
  "tui.footer.mcp": " 个 MCP",
  "tui.footer.status": "/status",
  "tui.subagent.label": "子智能体",
  "tui.subagent.of": " / ",
  "tui.subagent.main": "主 ",
  "tui.subagent.prev": "上一个 ",
  "tui.subagent.next": "下一个 ",
  "tui.plugin.unknown_route": "未知插件路由：",
  "tui.plugin.go_home": "返回首页",
  "tui.startup.finishing": "启动收尾中...",
  "tui.startup.loading_plugins": "加载插件中...",
  "tui.prompt.shell_label": "SHELL",
  "tui.dialog.share.title": "分享会话",
  "tui.dialog.share.body": "确定要分享此会话吗？",
  "tui.dialog.redo.title": "确认重做",
  "tui.dialog.redo.body": "确定要恢复已撤销的消息吗？",

  // Agent names
  "tui.agent.name.build": "构建",
  "tui.agent.name.plan": "规划",
  "tui.agent.name.compose": "编排",

  // Variant names
  "tui.variant.name.high": "高性能",
  "tui.variant.name.medium": "中等",
  "tui.variant.name.low": "低",
  "tui.variant.name.xhigh": "超高",
  "tui.variant.name.max": "最大",

  // Variant dialog
  "tui.dialog.variant.title": "变体",
  "tui.dialog.variant.default": "默认",
  "tui.dialog.variant.high": "高性能",
  "tui.dialog.variant.medium": "中等",
