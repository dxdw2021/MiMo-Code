...
export const dict = {
  ...
  "tui.dialog.message.title": "訊息",
  "tui.dialog.message.revert": "復原",
  "tui.dialog.message.revert_desc": "復原到此訊息並還原檔案",
  "tui.dialog.message.copy": "複製",
  "tui.dialog.message.copy_desc": "複製訊息文字到剪貼簿",
  "tui.dialog.message.fork": "分支",
  "tui.dialog.message.fork_desc": "從此訊息建立新分支會話",
  ...
  "tui.model.variant.none": "無",
  "tui.model.variant.minimal": "最小",
  "tui.prompt.never_ask": "跳過提問",
  "tui.permission.required": "需要授權",
  "tui.permission.allow_once": "允許一次",
  "tui.permission.allow_always": "始終允許",
  "tui.permission.allow_always_short": "始終允許",
  "tui.permission.reject": "拒絕",
  "tui.permission.confirm": "確認",
  "tui.permission.cancel": "取消",
  "tui.permission.minimize": "最小化",
  "tui.permission.fullscreen": "全螢幕",
  "tui.session.toast.share_copied": "分享連結已複製到剪貼簿！",
  "tui.session.toast.share_copy_failed": "複製分享連結失敗",
  "tui.session.toast.no_provider": "請先連接服務商以壓縮會話",
