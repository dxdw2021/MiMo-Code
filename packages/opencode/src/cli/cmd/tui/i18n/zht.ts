...
export const dict = {
  ...
  "tui.tips.tab_agent":
    "按 {highlight}Tab{/highlight} 或 {highlight}Shift+Tab{/highlight} 在 構建 / 規劃 / 編排 智慧代理之間切換",
  "tui.tips.theme_mode":
  ...
  "tui.tips.plan_agent": "切換到 {highlight}規劃{/highlight} 智慧代理以取得建議而不實際變更",
  ...
  "tui.dialog.image.matrix": "矩陣雨",
  "tui.dialog.image.waves": "彩色波浪",
  "tui.dialog.image.solid": "純色背景",
  "tui.dialog.image.solid.prompt": "輸入十六進制顏色（如 #1a1b26）",
  "tui.dialog.image.solid.invalid": "無效的顏色值",
  "tui.dialog.image.starry": "星空",
  "tui.dialog.image.fire": "火焰",
  "tui.dialog.image.snow": "飄雪",
  "tui.dialog.image.rain": "下雨",
  "tui.dialog.image.aurora": "極光",
  "tui.dialog.image.plasma": "等離子",
  "tui.dialog.image.bubbles": "氣泡",
  "tui.dialog.image.confetti": "五彩紙屑",
  "tui.dialog.image.ripple": "漣漪",
  "tui.dialog.image.pulse": "脈衝",
  "tui.dialog.image.drift": "漂流",
  "tui.dialog.image.twinkle": "閃爍星星",
  ...
  "tui.command.desc.init": "引導式 AGENTS.md 設定",
  "tui.command.desc.review": "審查變更 [commit|branch|pr]，預設為未提交的變更",
  "tui.command.desc.dream": "從記憶檔案和原始軌跡中手動整合專案記憶",
  "tui.command.desc.distill": "在近期工作中發現重複工作流程，封裝為 skills、subagents 或 commands",
  "tui.command.desc.goal": "設定停止條件目標；持續執行直到評估機制判定目標達成，使用 /goal clear 中止",
  "tui.command.desc.deep-research": "深度多源、事實核查的研究報告（執行 deep-research 工作流程）",
  ...
  "tui.command.config.reload.title": "重新載入配置",
  "tui.command.config.reload.description": "重新載入項目配置、服務商和插件",
  "tui.command.config.reload.toast": "配置已重新載入",
  ...
  // Skill dialog
  "tui.dialog.skill.loading": "載入技能中...",

  // Provider dialog
  "tui.dialog.provider.connect_title": "連線服務商",
  "tui.dialog.provider.select_auth_method": "選擇驗證方式",
  "tui.dialog.provider.custom_provider": "+ 自訂服務商",
  "tui.dialog.provider.wizard.provider_id": "服務商 ID",
  "tui.dialog.provider.wizard.provider_id_placeholder": "例如：mimorouter",
  "tui.dialog.provider.wizard.display_name": "顯示名稱",
  "tui.dialog.provider.wizard.display_name_placeholder": "例如：MiMo Router",
  "tui.dialog.provider.wizard.base_url": "基礎網址",
  "tui.dialog.provider.wizard.base_url_placeholder": "https://.../v1",
  "tui.dialog.provider.wizard.api_key": "API 金鑰",
  "tui.dialog.provider.wizard.api_key_placeholder": "sk-...",
  "tui.dialog.provider.wizard.first_model_id": "首個模型 ID",
  "tui.dialog.provider.wizard.first_model_id_placeholder": "例如：claude-sonnet-4-6",
  "tui.dialog.provider.wizard.first_model_name": "首個模型名稱",
  "tui.dialog.provider.wizard.first_model_name_placeholder": "例如：Claude Sonnet 4.6",

  // Model dialog
  "tui.dialog.model.add_model": "+ 添加模型",
  "tui.dialog.model.select_model": "選擇模型",
  "tui.dialog.model.connect_provider": "連線服務商",
  "tui.dialog.model.view_all_providers": "檢視所有服務商",
  "tui.dialog.model.favorite": "收藏",
  "tui.dialog.model.add_wizard.model_id": "模型 ID",
  "tui.dialog.model.add_wizard.model_id_placeholder": "閘道模型 ID",
  "tui.dialog.model.add_wizard.display_name": "顯示名稱",
  "tui.dialog.model.add_wizard.display_name_placeholder": "在模型選擇器中顯示的名稱",
  ...
  "cli.providers.mimo_free.failed": "MiMo Auto (free) 自檢失敗",
  "cli.providers.mimo_free.default_set": "預設模型已切換為 mimo/mimo-auto（1M 上下文，免費）",
  "cli.providers.mimo_free.usage_hint": "無需登入，直接 mimo run 即可使用。如需付費/更高階模型，可重新選擇 MiMo 瀏覽器登入。",
  ...
  "tui.dialog.login.import_claude.no_key": "找不到 Claude Code API Key",
  ...
  "tui.permission.no_diff": "無差異內容",
  "tui.permission.edit_title": "編輯 {{path}}",
  "tui.permission.read_title": "讀取 {{path}}",
  "tui.permission.path_label": "路徑：{{path}}",
  ...
  "tui.permission.task_title": "{{type}} 任務",
  "tui.permission.webfetch_title": "WebFetch {{url}}",
  "tui.permission.url_label": "URL：{{url}}",
  "tui.permission.websearch_title": "Web 搜尋 \"{{query}}\"",
  "tui.permission.codesearch_title": "Exa 程式碼搜尋 \"{{query}}\"",
  "tui.permission.query_label": "查詢：{{query}}",
  "tui.permission.ext_dir_title": "存取外部目錄 {{dir}}",
  "tui.permission.patterns_label": "模式",
  "tui.permission.doom_loop_title": "在反覆失敗後繼續",
  "tui.permission.doom_loop_desc": "讓工作階段在反覆失敗的情況下繼續運行。",
  "tui.permission.call_tool_title": "呼叫工具 {{tool}}",
  "tui.permission.tool_label": "工具：{{tool}}",

  // Question dialog
  "tui.question.confirm_tab": "確認",
  "tui.question.select_all": "（可多選）",
  "tui.question.custom_answer": "輸入自訂答案",
  "tui.question.review_title": "回顧",
  "tui.question.not_answered": "（未回答）",

  // Prompt hint
  "tui.prompt.hint.minimize": "最小化",
  "tui.prompt.hint.fullscreen": "全螢幕",
  "tui.prompt.hint.select": "選擇",
  "tui.prompt.hint.confirm": "確認",
  "tui.prompt.hint.tab": "切換",
  ...
  // Agent names
  "tui.agent.name.build": "構建",
  "tui.agent.name.plan": "規劃",
  "tui.agent.name.compose": "編排",

  // Variant names
  "tui.variant.name.high": "高效能",
  ...
  // Variant dialog
  "tui.dialog.variant.title": "變體",
  "tui.dialog.variant.default": "預設",
  "tui.dialog.variant.high": "高效能",
  "tui.dialog.variant.medium": "中等",
  "tui.dialog.variant.low": "低",

  // Error messages
  "tui.error.copy_url_failed": "複製連結到剪貼簿失敗",
  "tui.error.share_failed": "分享工作階段失敗",
  "tui.error.unshare_failed": "取消分享失敗",
  "tui.error.copy_clipboard_failed": "複製到剪貼簿失敗",
  "tui.error.copy_transcript_failed": "複製工作階段記錄失敗",
  "tui.error.export_failed": "匯出工作階段失敗",
  "tui.error.workspace_adaptor_failed": "載入工作區介面卡失敗",
  "tui.error.workspace_create_failed": "建立工作區工作階段失敗",
  "tui.error.worktree_create_failed": "建立工作樹失敗",
  "tui.error.send_message_failed": "傳送訊息失敗",
  "tui.error.delete_workspace_failed": "刪除工作區失敗",
  "tui.error.delete_session_failed": "刪除工作階段失敗",
