...
export const dict = {
  ...
  "tui.dialog.message.title": "メッセージ",
  "tui.dialog.message.revert": "取り消す",
  "tui.dialog.message.revert_desc": "このメッセージに取り消してファイルを復元",
  "tui.dialog.message.copy": "コピー",
  "tui.dialog.message.copy_desc": "メッセージテキストをクリップボードにコピー",
  "tui.dialog.message.fork": "フォーク",
  "tui.dialog.message.fork_desc": "このメッセージからセッションをフォーク",
  "tui.dialog.variant.select": "バリアントを選択",
  ...
  "tui.model.variant.none": "なし",
  "tui.model.variant.minimal": "最小",
  "tui.prompt.never_ask": "質問しない",
  "tui.permission.required": "権限が必要です",
  "tui.permission.allow_once": "1回許可",
  "tui.permission.allow_always": "常に許可",
  "tui.permission.allow_always_short": "常に許可",
  "tui.permission.reject": "拒否",
  "tui.permission.confirm": "確認",
  "tui.permission.cancel": "キャンセル",
  "tui.permission.minimize": "最小化",
  "tui.permission.fullscreen": "フルスクリーン",
  "tui.session.toast.share_copied": "共有URLがクリップボードにコピーされました！",
  "tui.session.toast.share_copy_failed": "共有URLのコピーに失敗しました",
  "tui.session.toast.no_provider": "セッションを要約するにはプロバイダーに接続してください",
