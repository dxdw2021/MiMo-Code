...
export const dict = {
  ...
  "tui.dialog.message.title": "Mensaje",
  "tui.dialog.message.revert": "Revertir",
  "tui.dialog.message.revert_desc": "Revertir a este mensaje y restaurar archivos",
  "tui.dialog.message.copy": "Copiar",
  "tui.dialog.message.copy_desc": "Copiar texto del mensaje al portapapeles",
  "tui.dialog.message.fork": "Bifurcar",
  "tui.dialog.message.fork_desc": "Bifurcar sesión desde este mensaje",
  ...
  "tui.dialog.variant.select": "Seleccionar variante",
  "tui.dialog.variant.default": "Predeterminado",
  "tui.model.variant.low": "Bajo",
  "tui.model.variant.medium": "Medio",
  "tui.model.variant.high": "Alto",
  "tui.model.variant.xhigh": "Muy alto",
  "tui.model.variant.max": "Máximo",
  "tui.model.variant.none": "Ninguno",
  "tui.model.variant.minimal": "Mínimo",
  "tui.prompt.never_ask": "sin preguntas",
  ...
  "tui.permission.allow_always_short": "Permitir siempre",
  "tui.permission.reject": "Rechazar",
  "tui.permission.confirm": "Confirmar",
  "tui.permission.cancel": "Cancelar",
  "tui.permission.minimize": "minimizar",
  "tui.permission.fullscreen": "pantalla completa",
  "tui.session.toast.share_copied": "¡URL de compartición copiada al portapapeles!",
  "tui.session.toast.share_copy_failed": "Error al copiar la URL de compartición",
  "tui.session.toast.no_provider": "Conecta un proveedor para resumir esta sesión",
