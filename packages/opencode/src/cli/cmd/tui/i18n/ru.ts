...
export const dict = {
  ...
  "tui.dialog.message.title": "Сообщение",
  "tui.dialog.message.revert": "Отменить",
  "tui.dialog.message.revert_desc": "Отменить до этого сообщения и восстановить файлы",
  "tui.dialog.message.copy": "Копировать",
  "tui.dialog.message.copy_desc": "Копировать текст сообщения в буфер обмена",
  "tui.dialog.message.fork": "Ветвь",
  "tui.dialog.message.fork_desc": "Создать ветку сессии из этого сообщения",
  ...
  "tui.model.variant.low": "Низкий",
  "tui.model.variant.medium": "Средний",
  "tui.model.variant.high": "Высокий",
  "tui.model.variant.xhigh": "Очень высокий",
  "tui.model.variant.max": "Максимум",
  "tui.model.variant.none": "Нет",
  "tui.model.variant.minimal": "Минимум",
  "tui.prompt.never_ask": "без вопросов",
  "tui.permission.required": "Требуется разрешение",
  "tui.permission.allow_once": "Разрешить однократно",
  "tui.permission.allow_always": "Разрешить всегда",
  "tui.permission.allow_always_short": "Разрешить всегда",
  "tui.permission.reject": "Отклонить",
  "tui.permission.confirm": "Подтвердить",
  "tui.permission.cancel": "Отмена",
  "tui.permission.minimize": "свернуть",
  "tui.permission.fullscreen": "полный экран",
  "tui.session.toast.share_copied": "Ссылка для обмена скопирована в буфер обмена!",
  "tui.session.toast.share_copy_failed": "Не удалось скопировать ссылку для обмена",
  "tui.session.toast.no_provider": "Подключите провайдер для суммаризации сессии",
