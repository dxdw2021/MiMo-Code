...
export const dict = {
  ...
  "tui.dialog.message.revert": "Annuler",
  "tui.dialog.message.revert_desc": "Annuler vers ce message et restaurer les fichiers",
  "tui.dialog.message.copy": "Copier",
  "tui.dialog.message.copy_desc": "Copier le texte du message dans le presse-papiers",
  "tui.dialog.message.fork": "Fourchette",
  "tui.dialog.message.fork_desc": "Créer une session à partir de ce message",
  ...
  "tui.dialog.variant.select": "Sélectionner la variante",
  "tui.dialog.variant.default": "Par défaut",
  "tui.model.variant.low": "Faible",
  "tui.model.variant.medium": "Moyen",
  "tui.model.variant.high": "Élevé",
  "tui.model.variant.xhigh": "Très élevé",
  "tui.model.variant.max": "Maximum",
  "tui.model.variant.none": "Aucun",
  "tui.model.variant.minimal": "Minimal",
  "tui.prompt.never_ask": "sans questions",
  "tui.permission.required": "Autorisation requise",
  "tui.permission.allow_once": "Autoriser une fois",
  "tui.permission.allow_always": "Toujours autoriser",
  "tui.permission.allow_always_short": "Toujours autoriser",
  "tui.permission.reject": "Refuser",
  "tui.permission.confirm": "Confirmer",
  "tui.permission.cancel": "Annuler",
  "tui.permission.minimize": "minimiser",
  "tui.permission.fullscreen": "plein écran",
  "tui.session.toast.share_copied": "URL de partage copiée dans le presse-papiers !",
  "tui.session.toast.share_copy_failed": "Échec de la copie de l'URL de partage",
  "tui.session.toast.no_provider": "Connectez un fournisseur pour résumer cette session",
